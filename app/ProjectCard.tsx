          ...
          <div className="wrapper1 w-full px-4 md:px-20 max-w-screen-xl mx-auto">
            ...
            >
              ...
              <div className="content1 three-d text-3xl px-14 py-9">
                <div className="">
                  Fuelled by a passion for crafting impactful products, my
                  journey into programming began with Girls Who Code—an
                  experience that sparked my curiosity in tech. It wasn&apos;t
                  until I encountered Bitcoin that I found my true calling. The
                  technology behind it not only captivated me but also unveiled
                  a realm of exciting possibilities. Now, I&apos;m integrating
                  blockchain into my projects and I leverage my design skills to
                  enhance user experiences in innovative ways.
                </div>
            ...
            >
              ...
              <div className="content1 three-d text-3xl px-14 py-9">
                <div>
                  Currently working on the smart-dashboard, churro-relay, and
                  The League
                </div>
                <div className="p-5"></div>
